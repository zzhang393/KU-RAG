...
if __name__ == '__main__':
    ...
    text_metadata_file = './ok_vqa_index.csv'
    ...
    text_metadata = pd.read_csv(text_metadata_file, header=None).values.tolist()


    for i, (question, idx_result) in enumerate(zip(questions_list, idx_results)):
        img_name = f"{question['image_id']:012d}.jpg"


        img0 = f"./val2014/COCO_val2014_{question['image_id']:012d}.jpg"
            ...
            if len(dup_list) == 0:
                for j, sub_idx in enumerate(idx_result):
                    ...
                    if isinstance(cpt, list):
                        ...
                        cpt1 = cpt1 + cpt2
                    cpt = cpt0 + cpt1
                    img = f"../OVEN/wikipedia_images_full/{sub_idx['image']}.jpg"
                ...
                for j_idx in dup_list:
                    ...
                    if isinstance(cpt, list):
                        ...
                        cpt1 = cpt1 + cpt2
                cpt = cpt0 + cpt1
                img = f"../OVEN/wikipedia_images_full/{img_temp}.jpg"
                img_cpt = add_caption(img, cpt)
                img_list.append(img_cpt)
