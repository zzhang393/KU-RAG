...
if __name__ == '__main__':
    ...
    text_metadata_file = './wiki_text_index.csv'
    ...
    for i, (question, idx_result) in enumerate(zip(questions_list, idx_results)):
        ...
        save_path = f"./image_test2/{question['data_id']}.jpg"
            ...
            if len(dup_list) == 0:
                for j, sub_idx in enumerate(idx_result):
                    ...
                    if isinstance(cpt, list):
                        ...
                        cpt1 = cpt1 + cpt2
                    cpt = cpt0 + cpt1
                    img = f"./wikipedia_images_full/{sub_idx['image']}.jpg"
                ...
                for j_idx in dup_list:
                    ...
                    if isinstance(cpt, list):
                        ...
                        cpt1 = cpt1 + cpt2
                cpt = cpt0 + cpt1
                img = f"./wikipedia_images_full/{img_temp}.jpg"
                img_cpt = add_caption(img, cpt)
                img_list.append(img_cpt)
