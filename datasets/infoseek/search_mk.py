...
from query_segment2 import segment
...
def search_img(img_index, questions_list, seg_list=None, batch_size=16):
    ...
    for question in questions_list:
        if question['image_id'] in seg_list:
            image_paths_list.append(f"./image_seg2/{question['image_id']}.jpg")
        else:
...
if __name__ == "__main__":
    ...
    questions_list = []
    file_path = './qa_data/infoseek_test.jsonl'
    # img_set = set()
    data = []
    ...
    seg_result = './results/seg_result_info.json'
    seg_list = []
    ...
    img_results_file = './results/img_result_info.json'
    img_results = []
    ...
    mk_result_file = './results/mk_result_info.json'
    mk_results = []
    ...
    idx_results = []
    idx_result_file = './results/idx_result_info.json'
